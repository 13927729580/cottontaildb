 ...
 * @version 1.1
 */
class SuperBitLSH(private val s: Int, private val b: Int, d: Int, seed: Long, species: VectorValue<*>, private val considerImaginary: Boolean, samplingMethod: SuperBit.SamplingMethod) : Serializable {
